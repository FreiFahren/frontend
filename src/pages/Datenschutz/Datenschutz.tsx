        ...
        <>
            ...
            <br />
                ...
                <h2>3.  Erhebung und Nutzung von Daten</h2>
                    <p>
                        Die App erhebt folgende Daten, wenn eine Meldung über Ticketkontrolleure erstellt wird:
                    </p>
                    <ul>
                        <li>Linie</li>
                        <li>Station</li>
                ...
                <h2>4. Anonymität</h2>
                    <p>
                        Die App speichert keine personenbezogenen Daten der Nutzer. Die Meldungen sind anonym, und es können keine Rückschlüsse auf einzelne Personen gezogen werden.
                    </p>
                ...
                <h2>7. Zustimmung zur Datenschutzpolicy</h2>
                    <p>
                        Nutzer müssen der Datenschutzpolicy zustimmen, bevor sie eine Meldung in der App erstellen können. Diese Zustimmung ist Voraussetzung für die Nutzung der App.
                    </p>
                <h2>8. Datenschutzbeauftragter</h2>
                    <p>
                        Für Fragen zum Datenschutz steht Ihnen unser Datenschutzbeauftragter Johan Trieloff (johan@trieloff.net) zur Verfügung.
                    </p>
